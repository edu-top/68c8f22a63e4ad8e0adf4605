...
2. Предусмотреть неизменяемые свойства, возвращающие основные характеристики выборочной совокупности, хранящейся поле `data`:
...
Для расчета характеристик выборки по признаку $X$ использовать формулы, приведенные в приложенном файле.
