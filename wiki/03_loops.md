...
Во всех задачах для ввода данных использовать помощи модальные (диалоговые) окна, ввод данных обрабатывать на наличие ошибок, при этом вывод сообщений об ошибках осуществлять с помощью встроенных функций. В случае невалидного ввода перезапрашивать данные у пользователя.
