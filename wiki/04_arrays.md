...
3. Запросить у пользователя ряд значений любого типа. Ограничением последовательности является ввод пустого значения. Вывести в консоль два массива: исходный (значения в котором расположены в порядке введения пользователем) и с отсортированными по возрастанию значениями.
