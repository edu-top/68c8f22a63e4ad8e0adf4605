...
Политика «Одинакового источника» (*Same Origin policy*) ограничивает доступ окон и фреймов друг к другу.

Идея заключается в том, что если у пользователя открыто две страницы: *john-smith.com* и *gmail.com*, то у скрипта со страницы *john-smith.com* не будет возможности прочитать письма из *gmail.com*. Таким образом, задача политики «Одинакового источника» – защитить данные пользователя от возможной кражи.[^cross-window-communication]
