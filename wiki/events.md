...
- [События](#события)
  ...
  - [Передача данных в обработчик события](#передача-данных-в-обработчик-события)
    ...
    - [Итого](#итого)
    - [Задания](#задания)
      - [1. Скрыть элемент по нажатию кнопки](#1-скрыть-элемент-по-нажатию-кнопки)
      - [2. Спрятать себя](#2-спрятать-себя)
      - [3. Какой обработчик запустится?](#3-какой-обработчик-запустится)
      - [4. Передвиньте мяч по полю](#4-передвиньте-мяч-по-полю)
      - [5. Создать раскрывающееся меню](#5-создать-раскрывающееся-меню)
      - [6. Добавить кнопку закрытия](#6-добавить-кнопку-закрытия)
      - [7. Карусель](#7-карусель)
  - [Действия браузера по умолчанию](#действия-браузера-по-умолчанию)
    ...
    - [Итого](#итого-1)
    - [Задачи](#задачи)
      - [1. Почему не работает return false?](#1-почему-не-работает-return-false)
      - [2. Поймайте переход по ссылке](#2-поймайте-переход-по-ссылке)
      - [3. Галерея изображений](#3-галерея-изображений)
  ...
  - [Делегирование событий](#делегирование-событий)
    ...
    - [Итого](#итого-3)
    - [Задачи](#задачи-1)
      - [1. Сортируемая таблица](#1-сортируемая-таблица)
      - [2. Напишите JS-код, реализующий поведение «подсказка».](#2-напишите-js-код-реализующий-поведение-подсказка)
  ...
  - [Определение своих событий](#определение-своих-событий)
    ...
    - [Итого](#итого-4)
  - [Практическая работа. Работа с событиями](#практическая-работа-работа-с-событиями)
    - [Задания](#задания-1)
...
![Move ball coordinates](../img/move-ball-coords.svg)
...
![Bagua bubble](../img/bagua-bubble.svg)
...
##### 2. Напишите JS-код, реализующий поведение «подсказка».
