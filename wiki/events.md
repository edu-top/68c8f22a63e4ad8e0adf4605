...
- [События](#события)
  ...
  - [Передача данных в обработчик события. Объект события. Объект-обработчик](#передача-данных-в-обработчик-события-объект-события-объект-обработчик)
...
### Передача данных в обработчик события. Объект события. Объект-обработчик
