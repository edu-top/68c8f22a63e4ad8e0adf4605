...
- [Формы и элементы управления](#формы-и-элементы-управления)
  ...
  - [Validation API. Валидация элементов формы](#validation-api-валидация-элементов-формы)
    - [Ограничительная валидация HTML5](#ограничительная-валидация-html5)
...
#### Ограничительная валидация HTML5
HTML5 поддерживает нативную валидацию форм (HTML5 Constraint Validation) и их элементов. Для этого у полей ввода применяются различные атрибуты, которые настраивают валидацию. В частности, мы можем применять следующие атрибуты:
