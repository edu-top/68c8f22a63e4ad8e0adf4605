...
## 01. Основы JavaScript. Базовый синтаксис, типы данных, операции, консоль и отладчик

- [01. Основы JavaScript. Базовый синтаксис, типы данных, операции, консоль и отладчик](#01-основы-javascript-базовый-синтаксис-типы-данных-операции-консоль-и-отладчик)
...
- **`=`**
    ...
    Простое присваивание позволяет установить значение переменной:
    ```js
    let x;
