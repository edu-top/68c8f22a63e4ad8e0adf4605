...
#### Замена условных конструкций логическими операторами
...
Во всех задачах ввод данных и вывод сообщений (в том числе валидационных) осуществлять с помощью встроенных функций ввода-вывода, обрабатывать пользовательский ввод на наличие ошибок.
