...
- [Объектно-ориентированное программирование](#объектно-ориентированное-программирование)
  ...
  - [Инкапсуляция свойств. Геттеры и сеттеры](#инкапсуляция-свойств-геттеры-и-сеттеры)
...
[^4.7]: [Инкапсуляция свойств. Геттеры и сеттеры](https://metanit.com/web/javascript/4.7.php)
