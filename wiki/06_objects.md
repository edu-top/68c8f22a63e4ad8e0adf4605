...
Важно понимать, что в обычных функциях `this` определяется динамически — из контекста вызова (как и где функция была вызвана), а в стрелочных функциях `this` захватывается лексически — из области видимости, где функция была объявлена.
